...
const SignUpPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Sign-up submitted:', { name, email, password, agreeToTerms });
  };
          ...
          <VStack flex={1} align="start" spacing={8} w="full">
            ...
            <VStack align="start" spacing={6}>
              ...
              <Text fontSize="xl" color="rgba(255, 255, 255, 0.9)" maxW="lg" lineHeight="tall">
                Join thousands of developers using the most advanced Model Context Protocol system for AI development. 
                      ...
                      <VStack spacing={4} w="full">
                        ...
                        >
                          <Text color="rgba(255, 255, 255, 0.8)" fontSize="sm">
                            I agree to the{' '}
                            <Link color="#F97316" fontWeight="semibold" onClick={() => navigate('/terms')}>
                              Terms of Service
                            </Link>{' '}
                            and{' '}
                            <Link color="#F97316" fontWeight="semibold" onClick={() => navigate('/privacy')}>
                              Privacy Policy
                            </Link>
                          </Text>
                        </Checkbox>
                  ...
                  <VStack spacing={4}>
                    ...
                    >
                      <Text fontSize="sm" color="rgba(255, 255, 255, 0.8)" textAlign="center">
                        <Text as="span" fontWeight="bold" color="#22C55E">New User Benefits:</Text><br />
                        ✨ 100 Free AI requests per month<br />
